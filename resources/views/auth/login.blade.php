...
<head>
    ...
    <meta content="TShop" name="author" />
    <!-- App favicon -->
    <link rel="shortcut icon" href="{{ config('layout.resources.favicon') }}">
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Nunito+Sans:ital,wght@0,300;0,400;0,600;0,700;1,300;1,400;1,600;1,700">
    <!-- Bootstrap Css -->
        ...
        <div class="row justify-content-center">
            <div class="col-md-8 col-lg-6 col-xl-5">
                ...
                <div class="mt-5 text-center">
                    <div>
                        <p>© <script>document.write(new Date().getFullYear())</script> Skote. Crafted with <i class="mdi mdi-heart text-danger"></i> by
                            <a href="https://www.facebook.com/pham.v.trong.334" target="_blank">Phạm Trọng</a></p>
                    </div>
                </div>
